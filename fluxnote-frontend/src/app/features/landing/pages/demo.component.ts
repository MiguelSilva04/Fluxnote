...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-white">
      ...
      <section class="bg-gradient-to-br from-[#155347]/10 to-white py-20 lg:py-32">
              ...
              <div class="relative">
                ...
                <div class="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
                  <button class="bg-white bg-opacity-90 hover:bg-opacity-100 rounded-full p-6 transition-all transform hover:scale-105 shadow-lg cursor-pointer">
                    <svg class="w-12 h-12 text-[#155347] ml-1" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            @for (step of steps; track step.title; let i = $index) {
              <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center relative">
                <div class="inline-flex items-center justify-center w-20 h-20 bg-[#155347]/15 rounded-full text-[#155347] mb-6" [innerHTML]="step.icon"></div>
      ...
      <section class="py-20 bg-[#155347]/10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div class="bg-white rounded-2xl p-12 shadow-lg">
            <div class="mb-8">
              <svg class="w-12 h-12 text-[#155347] mx-auto" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-center">
              ...
              <div class="text-left">
                ...
                <div class="text-gray-600">Project Manager, TechFlow</div>
              </div>
            </div>
          </div>
        </div>
