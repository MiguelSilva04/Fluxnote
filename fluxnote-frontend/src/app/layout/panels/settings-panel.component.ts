...
import { PanelStateService, LanguageService } from '../../core/services';
  ...
  template: `
      ...
      <aside class="fixed right-0 top-0 h-full w-full sm:w-96 bg-white shadow-2xl z-50 flex flex-col transition-transform duration-300 ease-in-out"
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <h2 class="text-lg font-bold text-gray-900">{{ 'SETTINGS.TITLE' | translate }}</h2>
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-8">
          ...
          <div>
            <div class="flex items-center gap-2 mb-4">
              ...
              <h3 class="text-base font-bold text-gray-900">{{ 'SETTINGS.LANGUAGE.TITLE' | translate }}</h3>
            </div>
            <div class="relative">
              <div
          ...
          <div>
            <div class="flex items-center gap-2 mb-4">
              ...
              <h3 class="text-base font-bold text-gray-900">{{ 'SETTINGS.THEME.TITLE' | translate }}</h3>
            </div>
            <div class="space-y-2">
          ...
          <div>
            <div class="flex items-center gap-2 mb-4">
              ...
              <h3 class="text-base font-bold text-gray-900">{{ 'SETTINGS.NOTIFICATIONS.TITLE' | translate }}</h3>
            </div>
            <div class="space-y-3">
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <span class="text-sm font-medium text-gray-900">{{ 'SETTINGS.TITLE' | translate }}</span>
            </a>
          </div>
        </div>
