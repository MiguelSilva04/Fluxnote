...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      <!-- Header -->
      <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between shrink-0">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-lg font-bold text-gray-900 dark:text-gray-100">Version Comparison</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400">Comparing Version 7 and Version 6</p>
          </div>
        </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                <div class="flex items-center gap-2">
                  <h2 class="text-sm font-bold text-gray-900 dark:text-gray-100">Version 7</h2>
                  <app-badge variant="success">Current</app-badge>
                </div>
                <p class="text-xs text-gray-500 dark:text-gray-400">João Silva • 2 hours ago</p>
              </div>
            </div>
          </div>
          <div class="flex-1 overflow-y-auto p-6 bg-white dark:bg-gray-800">
            <div class="prose max-w-none dark:prose-invert">
              <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Market Analysis 2024</h3>
              ...
              <p class="text-gray-800 dark:text-gray-300 mb-4 bg-green-100 dark:bg-green-900/30 px-2 py-1 rounded">
        ...
        <div class="flex-1 flex flex-col">
          <div class="p-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
              <div>
                <div class="flex items-center gap-2">
                  <h2 class="text-sm font-bold text-gray-900 dark:text-gray-100">Version 6</h2>
                  <app-badge variant="outline">Previous</app-badge>
                </div>
                <p class="text-xs text-gray-500 dark:text-gray-400">Ana Clara • Yesterday at 14:30</p>
              </div>
            </div>
          </div>
          <div class="flex-1 overflow-y-auto p-6 bg-white dark:bg-gray-800">
            <div class="prose max-w-none dark:prose-invert">
              ...
              <p class="text-gray-800 dark:text-gray-300 mb-4 bg-red-100 dark:bg-red-900/30 px-2 py-1 rounded line-through">
      ...
      <div class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-6 py-3">
        <div class="flex items-center gap-6 text-sm">
          <div class="flex items-center gap-2">
            <div class="w-4 h-4 bg-green-100 dark:bg-green-900/40 rounded"></div>
            <span class="text-gray-600 dark:text-gray-400">Added content</span>
          </div>
          <div class="flex items-center gap-2">
            <div class="w-4 h-4 bg-red-100 dark:bg-red-900/40 rounded"></div>
            <span class="text-gray-600 dark:text-gray-400">Removed content</span>
          </div>
          <div class="flex items-center gap-2">
            <div class="w-4 h-4 bg-yellow-100 dark:bg-yellow-900/40 rounded"></div>
            <span class="text-gray-600 dark:text-gray-400">Modified content</span>
          </div>
        </div>
      </div>
    </div>
